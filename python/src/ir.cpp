...
void init_ir(py::module_ &&m) {
  py::enum_<PaddingOption>(m, "PADDING_OPTION", py::module_local(),
                           "Filling option enumeration class: specifies the "
                           "type of filling value when padding a tensor/array")
  ...
  py::enum_<CacheModifier>(m, "CACHE_MODIFIER", py::module_local(),
                           "Cache modifier enumeration class: specifies the "
                           "cache behavior of a tensor/array")
  ...
  py::enum_<RoundingMode>(m, "ROUNDING_MODE", py::module_local(),
                          "Rounding mode enumeration class: specifies the "
                          "rounding behavior of a floating-point operation")
  ...
  py::enum_<MemSyncScope>(m, "MEM_SYNC_SCOPE", py::module_local(),
                          "Memory synchronization scope enumeration class: "
                          "specifies the scope of memory synchronization")
  ...
  py::enum_<EvictionPolicy>(m, "EVICTION_POLICY", py::module_local(),
                            "Eviction policy enumeration class: specifies the "
                            "policy of evicting a tensor/array from cache")
      .value("NORMAL", EvictionPolicy::NORMAL, "Normal eviction policy")
      .value("EVICT_FIRST", EvictionPolicy::EVICT_FIRST,
             "Evict first eviction policy")
      .value("EVICT_LAST", EvictionPolicy::EVICT_LAST,
             "Evict last eviction policy");

  py::enum_<RMWOp>(m, "ATOMIC_OP", py::module_local(),
                   "Atomic operation enumeration class: specifies the type of "
                   "atomic operation")
  ...
  py::enum_<DescriptorReduceKind>(
      m, "DESCRIPTOR_REDUCE_KIND", py::module_local(),
      "Descriptor reduce kind enumeration class: specifies the reduce "
      "operation for a descriptor")
  ...
  py::enum_<PropagateNan>(
      m, "PROPAGATE_NAN", py::module_local(),
      "NaN propagation strategy enumeration class: specifies how NaN values "
      "are propagated in operations")
  ...
  py::enum_<InputPrecision>(m, "INPUT_PRECISION", py::module_local(),
                            "Input precision enumeration class: specifies the "
  ...
  py::enum_<ScaleDotElemType>(m, "SCALE_DOT_ELEM_TYPE", py::module_local(),
                              "Scale dot element type enumeration class: "
                              "specifies the precision of scale dot product")
